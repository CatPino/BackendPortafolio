...
public class webpayServiceImpl implements webpayService {
    ...
    public webpayServiceImpl(pagoService pagoService, JwtUtils jwtUtils) {
    ...
    @Override
    public Map<String, Object> crearTransaccion(PagoRequest request) {
        ...
        try {
            ...
            WebpayPlusTransactionCreateResponse tx = transaction.create(
                    buyOrder, sessionId, monto, returnUrl
            );
    ...
    @Override
    public String confirmarPago(String token, String sid) {
        try {
            ...
            Pago pago = new Pago();
            pago.setMetodoPago(commit.getPaymentTypeCode());
            pago.setFechaPago(OffsetDateTime.parse(commit.getTransactionDate()).toLocalDateTime());

            Boleta boleta = new Boleta();
            boleta.setNombreCliente((String) dataCliente.get("nombre"));
            boleta.setCorreoCliente((String) dataCliente.get("correo"));
            boleta.setTelefonoCliente((String) dataCliente.get("telefono"));
            ...
            return "https://frontend-portafolio-lumiskin-yebo.vercel.app/compra-exitosa?idBoleta=" + boleta.getIdBoleta();
